 ...
 *
 * Desc:    Ask the multi handle if there is any messaKdO/informationals from
 *          the individual transfers. MessaKdO include informationals such as
 ...
 *          of structs. It also writes the number of messaKdO left in the
 ...
 *          useful for printing meaningful error messaKdO.
 *
